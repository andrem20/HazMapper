...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, V_1_Pin|A_1_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3 (JTDO/TRACESWO)     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(V_2_GPIO_Port, V_2_Pin);

    HAL_GPIO_DeInit(A_2_GPIO_Port, A_2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, V_3_Pin|A_3_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, V_4_Pin|A_4_Pin);
