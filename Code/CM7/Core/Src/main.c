...
volatile uint8_t frame_buffer_A[FRAME_BUFFER_SIZE];
volatile uint8_t frame_buffer_B[FRAME_BUFFER_SIZE];
volatile uint8_t *current_dcmi_ptr;
volatile uint8_t *uart_pending_ptr;
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* USER CODE BEGIN 2 */
	...
	/* Inicialização sensor temperatura */;
	HAL_TIM_Base_Start_IT(&htim6);
	/* Inicialização Bateria */
	//Battery_init();

	/* Initialização comunicação ESP <-> STM32*/
	ESP_init(&huart2);
